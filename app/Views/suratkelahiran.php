        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <?php echo form_open_multipart('surat/cetakkelahiran/'); ?>
              <div class="card-body">
                  <div class="form-group">
                    <input type="hidden" name="id" id="id">
                    <label>Nomor KK</label>
                    <input type="number" name="no_kk" id="no_kk" class="form-control" readonly>
                  </div>
                  <div class="form-group">
                    <label>Nama</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="tanggal" name="alamat" class="form-control" readonly>
                  </div>
                  <div class="form-group">
