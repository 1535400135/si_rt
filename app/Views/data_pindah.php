        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <?php echo form_open_multipart('pindah/save'); ?>
              <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <label>Alasan</label>
                      <input type="text" name="alasan" class="form-control" placeholder="Masukan Alasan Pindah">
                    </div>
  ...
  <div class="card-footer clearfix">
     <div class="row">
      ...
      <div class="col-3">
        <?php echo form_open_multipart('pindah'); ?>
                ...
                <div class="tab-content p-0">
                  ...
                  <tr>
                    ...
                    <td><a href="#" id="set_dtl" data-toggle="modal" data-target="#modal-detail"
                      data-nik="<?= $value->nik ?>"
                      data-tanggal="<?= $value->tglpindah ?>"
                      data-alasan="<?= $value->alasan ?>"
                      class="btn btn-warning">Ubah</a> <a href="<?= base_url('pindah/delete/'.$value->nik) ?>" class="btn btn-danger">Hapus</a></td>
                  </tr>
                  <?php } ?>
                  </tbody>
                </table>  
  ...
  <div class="modal fade" id="modal-detail">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <?php echo form_open_multipart('pindah/update'); ?>
              <div class="card-body">
                  <div class="form-group">
                    <label>NIK</label>
                  ...
                  <div class="form-group">
                      <label>Tanggal Kematian</label>
                          <div class="input-group date"  id="reservationdate2" data-target-input="nearest">
                              <input type="text" name="tanggal" class="form-control datetimepicker-input" data-target="#reservationdate2" id="tanggal" />
                              <div class="input-group-append" data-target="#reservationdate2" data-toggle="datetimepicker">
                                <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                              </div>
                            </div>
                    ...
                    <div class="form-group">
                      <label>Alasan</label>
                      <input type="text" class="form-control" name="alasan" id="alasan" placeholder="Masukan Alasan">
                    </div>
  ...
  <div class="modal fade" id="modal-laporan">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <?php echo form_open_multipart('pindah/laporan'); ?>
              <div class="card-body">
                  <div class="form-group">
                    <label>Dari Tanggal</label>
